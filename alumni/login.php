            ...
            <div class="login_section">
               <div class="logo_login">
                  <div class="center">
                     ...
                     <h3 style="color:#e0e01d; margin-top: 20px;">PLP Alumni</h3>
                  </div>
               </div>
                  ...
                  <form method="post" name="login">
                     <fieldset>
                        <div class="field">
                           ...
                           <input type="text" class="form-control" placeholder="enter your email id" required="true" name="emailid" value="<?php if (isset($_COOKIE["user_login"])) {
