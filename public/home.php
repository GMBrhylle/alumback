									...
									<div class="event_body d-flex flex-row align-items-start justify-content-start">
										...
										<div class="event_content">
											...
											<div class="event_info_container">
												<div class="event_info"><i class="fa fa-clock-o" aria-hidden="true" style="color: black;"></i><span style="color: black;"><?php echo (new DateTime($row->Schedule))->format('Y-m-d, h:i A'); ?></span></div>
